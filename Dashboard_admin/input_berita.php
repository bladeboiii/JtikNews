<?php
session_start();
$id_admin_user = $_SESSION['id_user'] ?? 1;
?>
                ...
                <form action="proses_input_berita.php" method="POST" enctype="multipart/form-data" id="beritaForm" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <!-- Preview langsung -->
                            <div class="form-group">
                                <label><i class="fas fa-eye mr-1"></i>Preview Isi Berita</label>
